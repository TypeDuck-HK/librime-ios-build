...
build_xcframework() {
    ...
    lipo -create $OUTPUT_LIBRIME_DIR/macosx_x86_64/lib/rime.framework/Versions/Current/rime $OUTPUT_LIBRIME_DIR/macosx_arm64/lib/rime.framework/rime -output $FW_MACOSX_LIB
